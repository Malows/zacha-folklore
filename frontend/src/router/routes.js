...
const routes = [
  {
    ...
    children: [
      ...
      route('menu/:id', 'menu show', () => import('pages/menu/ShowPage.vue')),
      route('menu/:id/editar', 'menu edit', () => import('pages/menu/EditPage.vue')),
      ...
      route('reservas/:id', 'reservations show', () => import('pages/reservations/ShowPage.vue')),
      route('reservas/:id/editar', 'reservations edit', () => import('pages/reservations/EditPage.vue')),
      ...
      route('usuarios/:id', 'users show', () => import('pages/users/ShowPage.vue')),
      route('usuarios/:id/editar', 'users edit', () => import('pages/users/EditPage.vue'))
    ]
  },
